...
german_bocks = {
    'traditional_bock': {
        ...
        'food_pair': ['german', 'meat', 'vegetables', 'chocolate', 'camembert_cheese'],
        'serving_temp': ['40', '45'],
    }
}
...
while logging_active:
    ...
    if response == 'german':
        #if using fstring, will have to reference dictionary of beers somehow 
        print("German cuisine can be enjoyed with a variety of beers such as german helles, german pilsners, oktoberfest,german schwarzbier, vienna lagers, and traditional bocks .")
        prompt = "Would you like some examples and more info on any of the beers listed?      type yes or no "
        answer = input((prompt))
        answer = answer.lower()
        if answer == 'yes':
